...
1. Qt5 (установленный и настроенный).
2. Компилятор C++ (GCC, MSVC или Clang).
3. Qt Creator (рекомендуется для удобной разработки).
...
---
## Инструкции
Также присутсвуют гайды по проходению новеллы "Похищенная душа". Будьте очень внимательны, присутствуют СПОЙЛЕРЫ.
